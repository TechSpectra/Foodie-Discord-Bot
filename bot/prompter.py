ingredients_to_foods = {
    ...
    'chicken': ['grilled chicken', 'chicken curry', 'chicken soup', 'chicken tacos', 'chicken salad', 'lemon chicken'],
    ...
    'corn': ['corn on the cob', 'corn chowder', 'cornbread', 'corn salad', 'corn salsa', 'corn dog'],
    ...
    'chocolate': ['chocolate cake', 'chocolate chip cookies', 'chocolate mousse', 'chocolate fondue', 'chocolate milkshake', 'chocolate pudding'],
